...
export enum MeTypes {
  ...
  //Load user by email
  LOAD_USERBYEMAIL_REQUEST = '@me/LOAD_USERBYEMAIL_REQUEST',
  LOAD_USERBYEMAIL_SUCCESS = '@me/LOAD_USERBYEMAIL_SUCCESS',
  LOAD_USERBYEMAIL_FAILURE = '@me/LOAD_USERBYEMAIL_FAILURE',
