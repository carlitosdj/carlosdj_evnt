...
export enum LeadTypes {
  ...
  //Send Email Single
  CREATE_SENDEMAILSINGLE_REQUEST = '@lead/CREATE_SENDEMAILSINGLE_REQUEST',
  CREATE_SENDEMAILSINGLE_SUCCESS = '@lead/CREATE_SENDEMAILSINGLE_SUCCESS',
  CREATE_SENDEMAILSINGLE_FAILURE = '@lead/CREATE_SENDEMAILSINGLE_FAILURE',
