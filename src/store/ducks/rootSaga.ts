...
import {loginUser, createMe, updateMe, deleteMe, recoveryUser, loadMe, loadUserByEmail} from './me/sagas'
...
import {loadLead, createLead, confirmLead, notDisturbLead, sendEmail} from './lead/sagas'
...
import { createPagarMeOrder, createPayment, createPaymentPixBoleto } from './payment/sagas'
...
export default function* rootSaga() {
  yield all([
    ...
    takeLatest(PaymentTypes.CREATE_PAYMENT_PIX_BOLETO_REQUEST, createPaymentPixBoleto),
